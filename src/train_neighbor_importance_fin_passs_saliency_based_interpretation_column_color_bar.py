...
def plot_spectral_biclustering_heatmap_topk(
    scores,
    row_labels,
    col_labels,
    row_order,
...
def plot_bio_biclustering_heatmap_unsort(
    ...
    model = SpectralBiclustering(n_clusters=(12, 7), method='log', random_state=0)
...
def train(args):
    ...
    for cluster_type, cluster_labels, relevance_scores_subset, tag in [
        ...
        if tag == "bio":
            ...
            # plot_spectral_biclustering_heatmap_topk(
            #     features=features,
            #     node_names=node_names,
            #     feature_names=feature_names,
            #     pred=pred,
            #     cgc_path="path/to/cancer_gene_census.csv",
            #     model_dir="results/biclustering",
            #     top_k=1000
            # )
