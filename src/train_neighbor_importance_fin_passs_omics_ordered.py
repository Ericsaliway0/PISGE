...
def save_reduced_feature_relevance_scores_(
    ...
    cancer_types = ['BLCA', 'BRCA', 'CESC', 'COAD', 'ESCA', 'HNSC', 'KIRC',
...
def plot_feature_importance_bio_omics_ordered(relevance_vector, feature_names, node_name=None, output_path="plots"):
    """
...
def plot_cluster_lrp_heatmap_omics_legend_bar_pass(relevance_scores, cluster_tensor, feature_names, output_path, n_clusters=12):
    ...
    omics_types = ['cna', 'ge', 'meth', 'mf']  # Order matches your input
    omics_colors = {
        'mf': '#b22222',     # dark red
        'cna': '#9370DB',    # purple
        'meth': '#00008B',   # dark blue
