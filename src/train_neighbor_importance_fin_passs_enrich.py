...
def plot_topo_biclustering_heatmap_sorted(
    args,
    relevance_scores,
    cluster_labels,
    output_path,
...
def plot_bio_biclustering_heatmap_sorted(
    args,
    relevance_scores,
    cluster_labels,
    omics_splits,
...
def train(args):
    ...
    fig.legend(handles=legend_patches, loc='upper center', ncol=2, frameon=False, bbox_to_anchor=(0.5, 1.08))
