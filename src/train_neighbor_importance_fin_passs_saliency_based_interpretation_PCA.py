...
def apply_full_spectral_biclustering_bio(
    ...
    # === t-SNE Visualization ===
    if summary_bio_features_trained.shape[0] >= 2 and summary_bio_features_trained.shape[1] >= 2:
        try:
            ...
            plt.legend()
            plt.tight_layout()
            tsne_path = output_path_genes_clusters.replace(".png", "_tsne_trained.png")
    ...
    if summary_bio_features_trained.shape[0] >= 2 and summary_bio_features_trained.shape[1] >= 2:
        try:
            ...
            plt.legend()
            plt.tight_layout()
            umap_path = output_path_genes_clusters.replace(".png", "_umap_trained.png")
    ...
    if summary_bio_features_trained.shape[0] >= 2 and summary_bio_features_trained.shape[1] >= 2:
        try:
            ...
            plt.legend()
            plt.tight_layout()
            pca_path = output_path_genes_clusters.replace(".png", "_pca_trained.png")
...
def train(args):
    ...
    bio_feats_initia_l = graph.ndata['feat'][:, :1024]  # biological features
