...
def apply_spectral_biclustering(graph, embeddings, node_names, predicted_cancer_genes, n_clusters, save_path, output_path_genes_clusters):
...
def plot_spectral_biclustering_heatmap_pass(
    ...
    # 🔹 Adjust layout and spacing
    plt.subplots_adjust(wspace=0, hspace=0)  # Tighten spacing between subplots
