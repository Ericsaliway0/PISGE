...
def train_(args):
    ...
    with torch.no_grad():
        ...
        performance_txt_path = os.path.join(output_dir, f'{args.model_type}_{args.net_type}_performance_metrics_epo{args.num_epochs}_infeats{args.in_feats}.txt')
    ...
    model_csv_path = os.path.join(output_dir, f'{args.model_type}_{args.net_type}_model_structure_epo{args.num_epochs}_infeats{args.in_feats}.csv') 
    ...
    output_file_above = os.path.join(
        ...
        f'{args.model_type}_{args.net_type}_predicted_driver_genes_above_epo{args.num_epochs}_infeats{args.in_feats}.csv'
    )
    output_file_below = os.path.join(
        'results/gene_prediction/',
        f'{args.model_type}_{args.net_type}_predicted_driver_genes_below_epo{args.num_epochs}_infeats{args.in_feats}.csv'
    )
    ...
    degree_output_file_above = os.path.join(
        'results/gene_prediction/',
        f'{args.model_type}_{args.net_type}_predicted_driver_gene_degrees_above_epo{args.num_epochs}_infeats{args.in_feats}.csv'
    )
    ...
    output_above_file = os.path.join('results/gene_prediction/', f'{args.model_type}_{args.net_type}_output_above_file_epo{args.num_epochs}_infeats{args.in_feats}.csv')
    output_below_file = os.path.join('results/gene_prediction/', f'{args.model_type}_{args.net_type}_output_below_file_epo{args.num_epochs}_infeats{args.in_feats}.csv')
...
def train(args):
    ...
    with torch.no_grad():
        ...
        # Save performance metrics to CSV
        performance_csv_path = os.path.join(output_dir, f'{args.model_type}_{args.net_type}_performance_metrics_epo{args.num_epochs}_infeats{args.in_feats}.csv')
...
def save_overall_metrics(total_time, average_time_per_epoch, average_cpu_usage, average_gpu_usage, args, output_dir):
    ...
    overall_metrics_csv_path = os.path.join(output_dir, f'{args.model_type}_{args.net_type}_overall_performance_epo{args.num_epochs}_infeats{args.in_feats}.csv')
...
def plot_degree_distributions(sorted_degree_counts_above, sorted_degree_counts_below, args, output_dir):
    ...
    # Save the plot
    os.makedirs(output_dir, exist_ok=True)
    output_plot_path = os.path.join(output_dir, f'{args.model_type}_{args.net_type}_degree_distributions_epo{args.num_epochs}_infeats{args.in_feats}.png')
...
def generate_kde_and_curves(logits, node_names, degree_counts_above, degree_counts_below, labels, train_mask, args):
    ...
    kde_output_path = os.path.join('results/gene_prediction/', f'{args.model_type}_{args.net_type}_kde_plot_epo{args.num_epochs}_infeats{args.in_feats}.png')
    ...
    output_file_roc = os.path.join('results/gene_prediction/', f'{args.model_type}_{args.net_type}_epo{args.num_epochs}_infeats{args.in_feats}_roc_curves.png')
    output_file_pr = os.path.join('results/gene_prediction/', f'{args.model_type}_{args.net_type}_epo{args.num_epochs}_infeats{args.in_feats}_pr_curves.png')
...
def plot_model_performance(args):
    ...
    # Save the plot
    comp_output_path = os.path.join('results/gene_prediction/', f'{args.model_type}_{args.net_type}_comp_plot_epo{args.num_epochs}_infeats{args.in_feats}.png')
