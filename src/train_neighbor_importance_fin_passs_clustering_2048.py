...
def train(args):
    ...
    # Slice biological relevance scores
    relevance_scores_bio = relevance_scores[:, :1024]
    relevance_scores_bio_topk = relevance_scores_bio[topk_node_indices_tensor]

    # Plot biological heatmap
    ...
    plot_bio_biclustering_heatmap(
        ...
        cluster_labels=cluster_labels_topk.cpu().numpy(),
        feature_names=feature_names,  # 64 bio features
        gene_names=node_names_topk,
        omics_splits=omics_splits,
