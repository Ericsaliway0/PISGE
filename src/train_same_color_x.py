...
# Call the plot function
    ...
    plot_tsne(data, features, "tsne_plot.png", cluster_colors)
...
def plot_tsne(data, features, output_path, cluster_colors):
    """
    Creates a t-SNE plot with the same cluster colors.
    
    Args:
        data (pd.DataFrame): Contains 'Cluster' column.
        features (np.array): Feature matrix for t-SNE.
        output_path (str): Path to save the t-SNE plot.
        cluster_colors (dict): Mapping of cluster labels to hex colors.
    """
