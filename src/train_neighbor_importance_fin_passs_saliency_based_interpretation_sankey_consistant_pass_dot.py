...
def draw_dot_plot_with_ratio(terms, cancer_type, source, top_n=20):
    ...
    for term in term_order:
        ...
        for _, row in clusters.iterrows():
            ...
            # Thresholds
            INSIDE_THRESHOLD = 1.0     # logp > this: label inside
            LEFT_MARGIN_THRESHOLD = 0.6  # logp < this: label to the left
            LABEL_PAD = 0.3            # padding distance from edge

            # Choose label position
            if logp >= INSIDE_THRESHOLD:
            ...
            elif logp < LEFT_MARGIN_THRESHOLD:
