...
def train(args):
    ...
    fig, axes = plt.subplots(2, 1, figsize=(12, 18))  # One plot for bio, one for topo
    ...
    axes[0].set_title("BIO Cluster Enriched Pathways")
    ...
    axes[1].set_title("TOPO Cluster Enriched Pathways")
    axes[1].set_xlabel("Cluster")
    axes[1].set_ylabel("Pathway")
    axes[1].tick_params(axis='x', labelrotation=90)

    # Optional: clean up spines for minimalism
    for ax in axes:
        for spine in ax.spines.values():
            spine.set_visible(False)
