...
def train(args):
    ...
    # 🔹 Output paths
    bio_confirmed_file = os.path.join(output_dir, f"{args.model_type}_{args.net_type}_BIO_confirmed_genes_epo{args.num_epochs}.txt")
    topo_confirmed_file = os.path.join(output_dir, f"{args.model_type}_{args.net_type}_TOPO_confirmed_genes_epo{args.num_epochs}.txt")
    ...
    for cluster_type, cluster_labels, relevance_scores_subset, tag in [
        ...
        if tag == "bio":
            ...
            save_and_plot_confirmed_genes_bio(
                ...
                output_dir=output_dir,
                confirmed_genes_save_path=bio_confirmed_file,
                tag="bio",
                confirmed_gene_path="data/ncg_8886.txt"
            )
            ...
            with open(bio_confirmed_file, "r") as f:
                confirmed_genes = [line.strip() for line in f if line.strip()]
            ...
            save_and_plot_confirmed_genes_topo(
                ...
                output_dir=output_dir,
                confirmed_genes_save_path=topo_confirmed_file,
                tag="topo",
                confirmed_gene_path="data/ncg_8886.txt"
            )

            # Load confirmed driver genes
            with open(topo_confirmed_file, "r") as f:
                confirmed_genes = [line.strip() for line in f if line.strip()]
