...
def cluster_and_visualize_predicted_genes(graph, predicted_cancer_genes, node_names, output_dir, num_clusters=12):
    """
    ...
    # Define 12 distinct colors for clusters (excluding red)
    cluster_colors = [
        '#0077B6', '#0000FF', '#00B4D8', '#48EAC4', '#6F2DBD', 
        '#FF7F0E', '#32CD32', '#FFD700', '#8A2BE2', '#E377C2',
        '#B56576', '#4A4E69'  # Added extra colors
    ]
    ...
    # Save plot
    os.makedirs(output_dir, exist_ok=True)
    plot_path = os.path.join(output_dir, "clustered_genes_12_clusters.png")
...
def cluster_and_visualize_predicted_genes_10(graph, predicted_cancer_genes, node_names, output_dir, num_clusters=10):
    """
    Clusters gene embeddings into groups using KMeans, visualizes them with t-SNE, 
    and marks predicted cancer genes with red circles (half the size of non-cancer dots).
    Saves predicted cancer genes per cluster in CSV files.
