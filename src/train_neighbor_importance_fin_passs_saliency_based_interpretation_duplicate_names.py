...
def plot_interactions_with_pcgs(data, output_path):
    ...
    ax = sns.boxplot(
        ...
        hue='Cluster', palette=cluster_color_map, showfliers=True
    )
...
def train(args):
    ...
    summary_bio_features_trained = extract_summary_features_np_bio(bio_embeddings_trained)  # shape [num_nodes, 64]    
    ...
    summary_bio_features_initial = extract_summary_features_np_bio(bio_embeddings_initial)  # shape [num_nodes, 64]
