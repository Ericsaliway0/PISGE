...
def train(args):
    ...
    for cluster_type, cluster_labels, relevance_scores_subset, tag in [
        ...
        if tag == "bio":
            ...
            print('confirmed_genes---------------------------\n',confirmed_genes)
            print('confirmed_genes---------------------------length\n',len(confirmed_genes))
            # pring('confirmed_genes---------------------------shape\n',confirmed_genes.shape())
    ...
    node_id_to_name = {i: name for i, name in enumerate(node_names)}
    #print('node_id_to_name---------------------------shape\n',node_id_to_name)
    print('node_id_to_name---------------------------length\n',len(node_id_to_name))

    node_id_to_name_topk = {i: name for i, name in enumerate(node_names_topk)}
    #print('node_id_to_name_topk---------------------------shape\n',node_id_to_name_topk)
    print('node_id_to_name_topk---------------------------length\n',len(node_id_to_name_topk))
    
    neighbors_dict = get_neighbors_gene_names(graph, node_names, name_to_index, confirmed_genes)
    neighbors_dict = get_neighbors_gene_names(graph, node_names_topk, name_to_index, node_names_topk)
    pring('node_id_to_name---------------------------shape\n',node_id_to_name)
