...
def plot_topo_biclustering_heatmap(
    ...
    for cluster in unique_clusters:
        ...
        # Select top 50% of genes within the cluster
        top_k = max(1, len(sorted_cluster) // 2)  # ensure at least 1 gene
        top_cluster_genes = sorted_cluster[:top_k]
        sorted_indices.extend(top_cluster_genes)
