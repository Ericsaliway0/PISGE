...
def train(args):
    ...
    col_types = []  # Keep track of each column's group
    ...
    # === Plot ===
    fig, ax = plt.subplots(figsize=(0.7 * len(norm_data.columns), 0.3 * len(norm_data)))
    ...
    # Color x-axis labels based on type
    ...
    fig.legend(handles=legend_patches, loc='upper center', ncol=2, frameon=False, bbox_to_anchor=(0.5, 1.02))
