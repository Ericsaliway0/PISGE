...
def train(args):
    ...
    for cluster_type, cluster_labels, relevance_scores_subset, tag in [
        ...
        ridge_from_bio_path = os.path.join(
            output_dir, f"{args.model_type}_{args.net_type}_ridge_from_{tag}_epo{args.num_epochs}"
        )        
        omics_splits = {
            'cna': (0, 15),
            'ge': (16, 31),
        ...
        if tag == "bio":
            ...
            plot_all_omics_cancer_ridges(
                ...
                node_names=node_names,
                cluster_labels=cluster_labels,
                output_base_path=ridge_from_bio_path,
                top_n=12
            )
